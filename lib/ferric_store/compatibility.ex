defmodule FerricStore.Compatibility do
  ...
  FerricStore 0.11 is a breaking beta API contract. SDK 0.11.10 requires server
  `~> 0.11.4`; native wire framing remains protocol v1.
  """

  @minimum_server_version "0.11.4"
  @server_version_requirement "~> 0.11.4"
  @protocol_version 1
